...
<html lang="en">
  ...
  <title>opencv3test/main.cpp at Develop · DarcyCode/opencv3test · GitHub</title>
  ...
  <meta name="request-id" content="232E:20944:77E7D9:B074D1:593F9F3D" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="232E:20944:77E7D9:B074D1:593F9F3D" name="octolytics-dimension-request_id" /><meta content="sea" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="">
    ...
    <meta name="js-proxy-site-detection-payload" content="YTlmNGQ0MjkwYzE4MWQzMGQyZTI2NzAxOThkM2U2ZDg3MDAzMDQxYTAwOGYyNWU3ZDFjYmEwZTUwNjljZjY1Y3x7InJlbW90ZV9hZGRyZXNzIjoiNjEuMTkxLjI1LjE5NSIsInJlcXVlc3RfaWQiOiIyMzJFOjIwOTQ0Ojc3RTdEOTpCMDc0RDE6NTkzRjlGM0QiLCJ0aW1lc3RhbXAiOjE0OTczNDE3NjEsImhvc3QiOiJnaXRodWIuY29tIn0=">
  ...
  <link href="https://github.com/DarcyCode/opencv3test/commits/Develop.atom" rel="alternate" title="Recent Commits to opencv3test:Develop" type="application/atom+xml">
    ...
    <link rel="canonical" href="https://github.com/DarcyCode/opencv3test/blob/Develop/opencv3test/main.cpp" data-pjax-transient>
...
<meta name="theme-color" content="#1e2327">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/DarcyCode/opencv3test/search" class="js-site-search-form" data-scoped-search-url="/DarcyCode/opencv3test/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/DarcyCode/opencv3test/blob/Develop/opencv3test/main.cpp" class="header-search-scope no-underline">This repository</a>
      <input type="text"
        ...
        <input type="hidden" class="js-site-search-type-field" name="type" >
          ...
          <a class="text-bold site-header-link" href="/login?return_to=%2FDarcyCode%2Fopencv3test%2Fblob%2FDevelop%2Fopencv3test%2Fmain.cpp" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/DarcyCode/opencv3test/blob/8690e9bcf42d682c312cdcb1b64a14ff554ddedd/opencv3test/main.cpp" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:30049d583032853e622fa3f8a8a69edc -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/DarcyCode/opencv3test/blob/Develop/opencv3test/main.cpp"
               data-name="Develop"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/DarcyCode/opencv3test/blob/master/opencv3test/main.cpp"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/DarcyCode/opencv3test/commit/17818a0285d8aa8e1f3e79a060a792dbdbf3c1c2" data-pjax>
          17818a0
        </a>
        <relative-time datetime="2017-06-12T13:36:05Z">Jun 12, 2017</relative-time>
      </span>
      <div>
        <img alt="@DarcyCode" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/22005397?v=3&amp;s=40" width="20" />
        <a href="/DarcyCode" class="user-mention" rel="author">DarcyCode</a>
          <a href="/DarcyCode/opencv3test/commit/17818a0285d8aa8e1f3e79a060a792dbdbf3c1c2" class="message" data-pjax="true" title="add better cylinderexpansion function">add better cylinderexpansion function</a>
      </div>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@DarcyCode" height="24" src="https://avatars3.githubusercontent.com/u/22005397?v=3&amp;s=48" width="24" />
            <a href="/DarcyCode">DarcyCode</a>
          </li>
      </ul>
    </div>
  </div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/DarcyCode/opencv3test/raw/Develop/opencv3test/main.cpp" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/DarcyCode/opencv3test/blame/Develop/opencv3test/main.cpp" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/DarcyCode/opencv3test/commits/Develop/opencv3test/main.cpp" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
  ...
  <div itemprop="text" class="blob-wrapper data type-c">
      ...
      <tr>
        ...
        <td id="LC3" class="blob-code blob-code-inner js-file-line">#<span class="pl-k">include</span> <span class="pl-s"><span class="pl-pds">&quot;</span>Algorithm.h<span class="pl-pds">&quot;</span></span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC8" class="blob-code blob-code-inner js-file-line"><span class="pl-k">int</span> <span class="pl-en">matsize</span>(vector&lt;Mat&gt;&amp; vm)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC10" class="blob-code blob-code-inner js-file-line">	<span class="pl-k">return</span> vm.<span class="pl-c1">size</span>();</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC12" class="blob-code blob-code-inner js-file-line">RNG <span class="pl-en">rng</span>( <span class="pl-c1">12345</span>);</td>
      </tr>
      <tr>
        <td id="L13" class="blob-num js-line-number" data-line-number="13"></td>
        <td id="LC13" class="blob-code blob-code-inner js-file-line"><span class="pl-k">int</span> <span class="pl-en">main</span>()</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC15" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">//</span>	ConnComponetLabelDemo();</span></td>
      </tr>
      <tr>
        <td id="L16" class="blob-num js-line-number" data-line-number="16"></td>
        <td id="LC16" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">//</span>	CCLabelingDemo();</span></td>
      </tr>
      <tr>
        <td id="L17" class="blob-num js-line-number" data-line-number="17"></td>
        <td id="LC17" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">//</span>	SelectRegionDemo();</span></td>
      </tr>
      <tr>
        <td id="L18" class="blob-num js-line-number" data-line-number="18"></td>
        <td id="LC18" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">//</span>	FMTmatchDemo();</span></td>
      </tr>
      <tr>
        <td id="L19" class="blob-num js-line-number" data-line-number="19"></td>
        <td id="LC19" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">//</span>	FastHazeRemovalDemo();</span></td>
      </tr>
      <tr>
        <td id="L20" class="blob-num js-line-number" data-line-number="20"></td>
        <td id="LC20" class="blob-code blob-code-inner js-file-line">	<span class="pl-c1">CylinderExpansionTest</span>();</td>
      </tr>
      <tr>
        <td id="L21" class="blob-num js-line-number" data-line-number="21"></td>
        <td id="LC21" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">//</span>	StatFeatureInfoDemo();</span></td>
      </tr>
      <tr>
        <td id="L22" class="blob-num js-line-number" data-line-number="22"></td>
        <td id="LC22" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">//</span>	SelectShapeDemo();</span></td>
      </tr>
      <tr>
        <td id="L23" class="blob-num js-line-number" data-line-number="23"></td>
        <td id="LC23" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">//</span>	floodfilltest();</span></td>
      </tr>
      <tr>
...
<div class="container site-footer-container">
  <div class="site-footer " role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.08809s from github-fe146-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
